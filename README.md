...
Nice thing about refactorings (initially described in Martin Fowler's [Refactoring book](https://martinfowler.com/books/refactoring.html)) is that you most often need just two letters to represent them uniquely in a way that it's easy to remember them. That helps me with being able to make committing tiny changes so cheap that I can often commit multiple times per minute without feeling that committing is slowing me down while minimizing cognitive load along the way as I don't have to think at all about the changes I didn't yet commit.
