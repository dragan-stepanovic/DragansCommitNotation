...
### Commit notation
**Heuristic**: Keep commit messages short to reduce the relative cost of committing. The easier it is to commit, the more often I'll do it, the smaller the changes I make.  
