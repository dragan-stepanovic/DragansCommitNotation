...
These are the refactorings that I found I use the most and for those I want to reduce the cost of doing them by (also) reducing the cost of committing the change once I do it:
